    ...
    : QMainWindow(parent)
{
    ...
    _scene->setWireFactory([]{ return QSchematic::make_origin<FancyWire>(); });
...
void MainWindow::demo()
{
    ...
    auto o1 = QSchematic::make_origin<Operation>();
    o1->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 2), QStringLiteral("in")));
    o1->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(8, 2), QStringLiteral("out")));
    o1->setGridPos(0, 0);
    o1->setSize(160, 80);
    ...
    auto o2 = QSchematic::make_origin<Operation>();
    o2->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 2), QStringLiteral("in")));
    o2->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(8, 2), QStringLiteral("out")));
    o2->setGridPos(-14, 9);
    o2->setSize(160, 80);
    ...
    auto o3 = QSchematic::make_origin<Operation>();
    o3->setSize(160, 120);
    o3->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 2), QStringLiteral("in 1")));
    o3->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 4), QStringLiteral("in 2")));
    o3->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(8, 3), QStringLiteral("out")));
    o3->setGridPos(18, -8);
    ...
    auto o4 = QSchematic::make_origin<Operation>();
    o4->setSize(160, 120);
    o4->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 2), QStringLiteral("in 1")));
    o4->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(0, 4), QStringLiteral("in 2")));
    o4->addConnector(QSchematic::make_origin<OperationConnector>(QPoint(8, 3), QStringLiteral("out")));
    o4->setGridPos(18, 10);
