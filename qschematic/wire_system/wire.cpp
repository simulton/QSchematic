...
void
wire::set_manager(wire_system::manager* manager)
{
    m_manager = manager;
}
...
int
wire::points_count() const
{
    return m_points.count();
}

QVector<int>
wire::junctions() const
{
    if (points_count() < 2)
        return {};
...
QList<wire*>
wire::connected_wires()
{
    return m_connectedWires;
}

QList<line>
wire::line_segments() const
{
...
void
wire::move_junctions_to_new_segment(const line& oldSegment, const line& newSegment)
{
...
void
wire::move_point_to(int index, const QPointF& moveTo)
{
...
void
wire::set_point_is_junction(int index, bool isJunction)
{
    if (index < 0 || index > points_count() - 1)
        return;
...
void
wire::prepend_point(const QPointF& point)
{
    about_to_change();
...
void
wire::append_point(const QPointF& point)
{
    about_to_change();
...
void
wire::move_line_segment_by(int index, const QVector2D& moveBy)
{
...
void
wire::insert_point(int index, const QPointF& point)
{
    // Boundary check
...
void
wire::move_point_by(int index, const QVector2D& moveBy)
{
    if (index < 0 || index > points_count() - 1)
        return;
...
bool
wire::point_is_on_wire(const QPointF& point) const
{
...
void
wire::move(const QVector2D& movedBy)
{
...
void
wire::setNet(const std::shared_ptr<wire_system::net>& net)
{
    m_net = net;
}
...
void
wire::disconnectWire(wire* wire)
{
    m_connectedWires.removeAll(wire);
}

void
wire::remove_point(int index)
{
    about_to_change();
